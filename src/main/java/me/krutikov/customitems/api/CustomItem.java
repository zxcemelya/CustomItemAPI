...
public abstract class CustomItem {
    ...
    @SuppressWarnings("Not for getting an item stack!")
    private ItemStack baseStack;


    public void click(Player player, Action clickType, ItemStack itemStack) {
        ...
        use(player, clickType, itemStack);
        PlayerCooldownUtil.putCooldown(cooldownName, player, delay);

    }
    protected abstract void use(Player player, Action clickType, ItemStack itemStack);
